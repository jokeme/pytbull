...
class Pytbull():
    ...
    def doMultipleFailedLoginsTest(self, payloads):
        ...
        ftp = FTP(self._target)
        for payload in payloads:
            print "==> FTP login attempt with %s/%s" % (payload[0], payload[1])
            try:
...
@                                           @   @        @                  @
        ...
        self.writeReport("""
            ...
            <div style="font-size:9pt;margin-top:150px;">(C) This report has been generated by <a href="http://code.google.com/p/pytbull/">pytbull</a></div>
            </td></tr></table>
            <hr />
        """)
    ...
    def finalizeReport(self):
        ...
        self.writeReport("""<hr /><div style="font-size:9pt;">(C) This report has been generated by <a href="http://code.google.com/p/pytbull/">pytbull</a></div>""")
